...
public class AdviceText : MonoBehaviour {
    ...
    static private int wetCount = ClimateCloaks.wetCount;
    static private int baseNatTemp = ClimateCloaks.baseNatTemp;
    static private int natTemp = ClimateCloaks.natTemp;
    static private int armorTemp = ClimateCloaks.armorTemp;
    static private int pureClothTemp = ClimateCloaks.pureClothTemp;
    ...
    {
        wetCount = ClimateCloaks.wetCount;
        baseNatTemp = ClimateCloaks.baseNatTemp;
        natTemp = ClimateCloaks.natTemp;
        armorTemp = ClimateCloaks.armorTemp;
        pureClothTemp = ClimateCloaks.pureClothTemp;
    ...
    {
        Debug.Log("[Climates & Cloaks] TxtClothing");
    ...
    public static string TxtAdvice()
    {
        ...
        {
            if (armorTemp > 11 && playerEnterExit.IsPlayerInSunlight && !ClimateCloaks.ArmorCovered())
            {
            ...
            else if (totalTemp > 30 && ClimateCloaks.wetPen && playerGPS.IsPlayerInLocationRect)
            {
